...
const CartNavigator = ({ currentStep }) => {
  ...
  return (
    <div className="fixed lg:top-24 top-32 left-0 right-0 z-20 flex flex-row items-center justify-center bg-gray-100 p-2 rounded-full max-w-[90%] md:max-w-4xl mx-auto">
