        ...
        <div className="w-64 h-screen bg-white border-r flex flex-col justify-between">
            <div>
                ...
                <nav className="mt-4 flex flex-col space-y-2 px-4">
                    <SidebarItem to="/dashboard/" icon={<AiOutlineProduct className="w-5 h-5" />} label="Dashboard" />
                    <SidebarItem to="/dashboard/products" icon={<AiOutlineProduct className="w-5 h-5" />} label="Products" />
